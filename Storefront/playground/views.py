...
def api_test(request):
    return render(request, 'playground/api_test.html')

@login_required
def api_checkout_test(request):
    return render(request, 'playground/api_checkout.html')
